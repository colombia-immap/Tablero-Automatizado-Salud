# -*- coding: utf-8 -*- 
"""
Created on Mon May  9 17:05:31 2022
...
muni = df_api_sector_mes['Full Name'].unique()
...
#nuevamente pego las columnas basandome en el sector mes
right_join = df_api_sector_mes 
right_join.nunique()
right_join= right_join[['Full Name','dpto','mpio','Departamento_x', 'Municipio_x']]
Municipios_Alcanzados = right_join.pivot_table(index=['Full Name','dpto','mpio'
                                                      ,'Departamento_x', 'Municipio_x'])
...
Writer= pd.ExcelWriter("C:/Users/Lisa/Documents/Bases de Python/Bases Actualizables/tablero_Salud_03_2022.xlsx")
